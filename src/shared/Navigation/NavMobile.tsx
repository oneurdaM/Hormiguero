...
const NavMobile: React.FC<NavMobileProps> = ({ data = NAVIGATION, onClickClose }) => {
    ...
    const [tokenNav, setTokenNav] = useState<any>(null)
    useEffect(() => {
    ...
    return (
        <div className="overflow-y-auto w-full h-screen py-1 transition transform shadow-lg ring-1 dark:ring-neutral-700 bg-white dark:bg-neutral-900 divide-y-2 divide-neutral-100 dark:divide-neutral-800">
            ...
            <ul className="flex flex-col py-2 px-2 space-y-1">{data.map(_renderItem)}</ul>

            <div className="p-5  mt-5 text-neutral-700 dark:text-neutral-300 text-sm">
                <p>
                    <small>
                        <b>Nuestra misión </b> En Centro Cultural El Hormiguero, enriquecemos vidas a través del teatro, inspirando y conectando a nuestra comunidad.
                    </small>
                </p>
                <br />
                <p>
                    <small>
                        ...
                        ser un referente destacado en el mundo del teatro, combinando excelencia artística con inclusión e innovación.
                    </small>
                </p>
                <br />
                <p>
                    <small>Somos amantes del teatro dedicados a producir obras que despiertan emociones y promueven la reflexión en un espacio de expresión para todos. ¡Únete a nuestra travesía teatral en Centro Cultural El Hormiguero!</small>
                </p>
