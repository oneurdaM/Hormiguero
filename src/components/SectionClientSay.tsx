...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Jhon Doe",
    clientAddress: "México",
    content:
      "This place is exactly like the picture posted on Hormiguero. Great service, we had a great experience!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Lo que nuestros clientes opinan de El Hormiguero" isCenter>
        Opiniones
      </Heading>
